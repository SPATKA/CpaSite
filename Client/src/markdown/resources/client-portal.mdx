...
Check out this video to see the portal in action. See how to use the SecureSend feature to quickly and easily send files to the secure portal environment.

To start using the client portal please log in above or register here.  


To send a file without creating an account use the **[SecureSend page](https://knaikassociates.securefilepro.com/portal/#/login)**.  
